package com.android.zj.listener.ui.activity.ads.ym;
...
public class SplashActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!TextUtils.isEmpty(tag)) {
            ...
            final Intent intent = new Intent(this, com.android.zj.listener.ui.activity.MainActivity.class);
            startActivity(intent);
            this.finish();
        }
    }
    ...
    private void runApp() {
        //初始化SDK
        AdManager.getInstance(this).init("39deb76c34599d95", "3151b26a15bc4a5d", true);
        preloadAd();
